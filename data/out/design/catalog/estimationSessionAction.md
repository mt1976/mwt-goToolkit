...
| Type | Artifact | Path|
| :--: | -- | -- |
| code | **application** | /application/estimationSessionAction_core.go_tmp |
| code | **adaptor** | /dao/estimationSessionAction_adaptor.go_template_tmp |
| code | **api** | /application/estimationSessionAction_api.go_tmp |
| code | **dao** | /dao/estimationSessionAction_core.go_tmp |
| code | **datamodel** | /datamodel/estimationSessionAction_core.go_tmp |
| code | **menu** | /design/menu/estimationSessionAction.json_tmp |
