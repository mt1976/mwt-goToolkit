...
| Type | Artifact | Path|
| :--: | -- | -- |
| code | **application** | /application/profile_core.go_tmp |
| code | **adaptor** | /dao/profile_adaptor.go_template_tmp |
| code | **api** | /application/profile_api.go_tmp |
| code | **dao** | /dao/profile_core.go_tmp |
| code | **datamodel** | /datamodel/profile_core.go_tmp |
| code | **menu** | /design/menu/profile.json_tmp |
