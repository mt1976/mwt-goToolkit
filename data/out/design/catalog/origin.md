...
| Type | Artifact | Path|
| :--: | -- | -- |
| code | **application** | /application/origin_core.go_tmp |
| code | **adaptor** | /dao/origin_adaptor.go_template_tmp |
| code | **api** | /application/origin_api.go_tmp |
| code | **dao** | /dao/origin_core.go_tmp |
| code | **datamodel** | /datamodel/origin_core.go_tmp |
| code | **job** | /jobs/origin_core.go_tmp |
| code | **menu** | /design/menu/origin.json_tmp |
